...
def load_svhn(order='th', path=None, extra=False):
    ...
    if path is None:
        train_data = sio.loadmat('/home/eric/Github/ucla-computer-science/vcla/LALNets/lalnets/data/svhn/train_32x32.mat')
    else:
    ...
    if path is None:
        test_data = sio.loadmat('/home/eric/Github/ucla-computer-science/vcla/LALNets/lalnets/data/svhn/test_32x32.mat')
    else:
    ...
    if extra:
        if path is None:
            extra_data = sio.loadmat('/home/eric/Github/ucla-computer-science/vcla/LALNets/lalnets/data/svhn/extra_32x32.mat')
        else:
...
def load_norb(path=None):
    ...
    if path is None:
        X_train = np.load('/home/eric/Github/ucla-computer-science/vcla/LALNets/lalnets/data/norb/X_train.npy')
        y_train = np.load('/home/eric/Github/ucla-computer-science/vcla/LALNets/lalnets/data/norb/y_train.npy')
    else:
    ...
    if path is None:
        X_test = np.load('/home/eric/Github/ucla-computer-science/vcla/LALNets/lalnets/data/norb/X_test.npy')
        y_test = np.load('/home/eric/Github/ucla-computer-science/vcla/LALNets/lalnets/data/norb/y_test.npy')
    else:
...
def load_sar11(loc):
    ...
    for i in range(len(sample_id_map)):
