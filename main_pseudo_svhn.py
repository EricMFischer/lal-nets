...
def main():
    ...
    #load SVHN
    (X_train, y_train), (X_test, y_test), input_shape, (_, _), = load_svhn('th', path='/home/eric/Github/ucla-computer-science/vcla/LALNets/lalnets/data/svhn/', extra=False)
    ...
    save_to_path = './temp/exp_svhn_ps8k20_cnn2_32_7_e1_1_e000001_4000_adam/'
